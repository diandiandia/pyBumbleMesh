...
class PBRemoteLink:
    ...
    async def send_transaction(self, pdu: bytes) -> bool:
        """Sends a provisioning PDU via the remote node."""
        ...
        # Remote PDUs are acknowledged at the Access Layer (RLC/Lower Transport)
        # So we just add a small delay for airtime.
